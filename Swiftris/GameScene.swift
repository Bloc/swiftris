...
class GameScene: SKScene {
    ...
    func addPreviewShapeToScene(_ shape:Shape, completion:() -> ()) {
    ...
    func movePreviewShape(_ shape:Shape, completion:() -> ()) {
        for block in shape.blocks {
    ...
    func redrawShape(_ shape:Shape, completion:() -> ()) {
        for block in shape.blocks {
            let sprite = block.sprite!
            let moveTo = pointForColumn(block.column, row:block.row)
    ...
    func animateCollapsingLines(_ linesToRemove: Array<Array<Block>>, fallenBlocks: Array<Array<Block>>, completion:() -> ()) {
